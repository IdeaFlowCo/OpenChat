...
export function MessageList() {
  ...
  if (messages.length === 0) {
    return (
      <div className="flex-1 flex items-center justify-center text-gray-400 dark:text-slate-500 bg-gray-50 dark:bg-slate-950">
    ...
    <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50 dark:bg-slate-950">
      ...
      {typingNames.length > 0 && (
        <div className="flex justify-start">
          <div className="bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 px-4 py-2 rounded-2xl rounded-bl-md text-sm italic">
